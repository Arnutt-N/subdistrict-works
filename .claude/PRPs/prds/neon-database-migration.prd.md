...
> โปรเจกต์: `huangua-citizen-help` — ระบบรับเรื่องร้องเรียน/ร้องทุกข์ อบต.หัวงัว (อ.ยางตลาด จ.กาฬสินธุ์)
...
**Primary User**
- **Who**: ผู้ดูแลระบบของ อบต.หัวงัว — เจ้าหน้าที่ที่รับผิดชอบเว็บไซต์เพิ่มจากงานประจำ ไม่ใช่ DBA ไม่ใช่ DevOps
...
- ประชาชนในตำบลหัวงัว ที่จะส่งเรื่องร้องเรียนผ่านเว็บหรือ LINE — **ไม่รู้จักคำว่า Neon และไม่ควรต้องรู้** สิ่งเดียวที่รู้สึกได้คือหน้าเว็บโหลดเร็วหรือช้า (ประเด็น cold start)
